...
allImages.forEach((el) => {
  ...
  const lbOpenObserver = new MutationObserver((mut) => {
    mut.forEach((mutation) => {
      ...
      console.log('lightbox open 2');
      var mainNav = document.querySelector('.main-nav');
      mainNav.style.opacity = '0';
      document.body.classList.remove('nav-active');
      document.querySelector('.main-nav-inner').classList.remove('nav-active');
      document.querySelector('.main-nav-reveal').classList.remove('nav-active');
      document.querySelector('.hamburger-line-1').classList.remove('hamburger-active');
      document.querySelector('.hamburger-line-2').classList.remove('hamburger-active');
      document.querySelector('.hamburger-line-3').classList.remove('hamburger-active');
      document.querySelector('.main-nav-inner').classList.remove('nav_is_scrolled')
