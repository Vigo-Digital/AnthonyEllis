 ...
 switch(galleryType) {
  case "Narrative":
    ...
    if (isImageLandscape(imageSizes[0].width, imageSizes[0].height) && isImageLandscape(imageSizes[1].width, imageSizes[1].height) && isImageLandscape(imageSizes[2].width, imageSizes[2].height)) {
      ...
      let rowImg1ParentElement = document.getElementsByClassName('w-dyn-item')[1];
      let rowImg1Element = imgParentElement.querySelector('img');
      rowImg1Element.classList.add("upline");
