  ...
  if (galleryType == "Uniform") {
    document.getElementById("NarrativeTemplate").remove;
  }
...
allImages.forEach((el) => {
 ...
 switch(galleryType) {
  ...
  case "Uniform":
    ...
    //First image already used - REMOVE
    const repeatedElement = document.querySelectorAll('.uniform, .w-dyn-item');
    console.log(repeatedElement[0]);
    console.log(repeatedElement[1]);
    repeatedElement[1].remove();
