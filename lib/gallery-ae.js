...
function getLoadedImages() {
  ...
  for (let imgis = 1; imgis < numberofActualImageElements; imgis++) {
    ...
    //let altLBRemainder = imgElement.alt.substring(imgElement.alt.lastIndexOf("*")+1);
    console.log(formatClearedAlt);

    console.log("-----starting portal check----");
    console.log("-----" + imgis + "----");
    console.log("image alt", imgElement.alt)
    console.log(getAndCheckAllPortalsTwo(formatClearedAlt));
    console.log("------------------------------");
