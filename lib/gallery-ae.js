	...
	function getAndCheckAllPortalsTwo(caption) {
		...
		for (portali = 0; portali < portals.length; portali++) {
			var portalDetail = {"Alt":portals[portali].innerHTML, "Gallery":portalUrls[portali].innerHTML, "Slug":portalSlugs[portali].innerHTML, "ExitGallery":portalExitGallery[portali].innerHTML, "ExitImage":portalExitImage[portali].innerHTML};
