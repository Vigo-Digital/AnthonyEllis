  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    var portalUrls = document.querySelector(".portal-gallery");
    ...
    for (portali = 0; portali < portals.length; portali++) {
      console.log("detail", portals[portali]);
      console.log("detail html", portals[portali].innerHTML);

      var portalDetail = {"Alt":portals[portali], "Gallery":portalUrls[portali]};
      allPortals[portali] = portalDetail;
      console.log("allPortals2", allPortals);
    }
