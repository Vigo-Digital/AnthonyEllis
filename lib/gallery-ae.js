...
const firstImgParentElement = document.getElementsByClassName('w-dyn-item')[1];
const firstImgElement = firstImgParentElement.querySelector('img');

firstImgElement.onload = function() {
  var width = firstImgElement.clientWidth;
  var height = firstImgElement.clientHeight;
