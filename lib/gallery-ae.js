	...
	/*
	let textBlock2 = document.getElementById("Text-Block-Replace-2").innerHTML;
	var newTextBlock2 = textBlock2.replaceAll('&gt;&gt;', '<br />');
	textBlock2.innerHTML = newTextBlock2;

	let textBlock3 = document.getElementById("Text-Block-Replace-3").innerHTML;
	var newTextBlock3 = textBlock3.replaceAll('&gt;&gt;', '<br />');
	textBlock3.innerHTML = newTextBlock3;*/
