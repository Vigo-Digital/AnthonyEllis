...
lbOpenObserver.observe(htmlTag, { attributeFilter: ["class"] });
  ...
  if (galleryType == "Narrative") {
    ...
    //console.log("here1");
    if (document.getElementById("Text-Block-Replace-2") != null) {
      createTextBlock(4, "linetopright", 2);
    }

    if (document.getElementById("Text-Block-Replace-3") != null) {
      var textBlock3 = document.createElement("div");
      textBlock3.className = 'text-block-10';
      textBlock3.id = 'Text-Block-Replace-3';
      andLastAnotherNewDiv.appendChild(textBlock3);
      let textBlockContent3 = document.getElementById("Text-Block-3").innerHTML;
      document.getElementById("Text-Block-Replace-3").innerHTML = textBlockContent3;
    }
