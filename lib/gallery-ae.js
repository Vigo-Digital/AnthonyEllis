...
allImages.forEach((el) => {
								...
								if (entry._src == imgLB.src) {
									...
									if (figExists == null) {
										...
										if (entry._alt)  {
											...
											figcaption.innerHTML = toTitleCase(boldedLBAlt.bold()) + "<br/>" + altLBRemainder;
										...
										if (entry._alt)  {
											let boldedLBAlt = entry._alt.substring(entry._alt.indexOf("*") + 1, entry._alt.lastIndexOf("*"));
											let altLBRemainder = entry._alt.substring(entry._alt.lastIndexOf("*")+1);
											figExists.innerHTML = toTitleCase(boldedLBAlt.bold()) + "<br/>" + altLBRemainder;
	...
	document.getElementById("Multi-Image-0-Caption-Block").innerHTML = toTitleCase(boldedAlt.bold()) + "<br/>" + altRemainder;
	...
	for (let imgi = 1; imgi < numberofImageElements; imgi++) {
		...
		if (elementToGetAlt != "") {
			...
			if (document.getElementById(multiImageBlockName)) {
				...
				document.getElementById(multiImageBlockName).innerHTML = toTitleCase(boldedAlt.bold()) + "<br/>" + altRemainder;
		 	} else {
				var photoLabelAltContentDiv = document.createElement("div");
				...
				photoLabelAltContentDiv.innerHTML = toTitleCase(boldedAlt.bold()) + "<br/>" + altRemainder;
			}
		}
	}
