...
function getMapDefaultLocation(location) {
    ...
    mapboxClient.geocoding.forwardGeocode({
        ...
        .then((response) => {
            ...
            console.log("zoom override", document.getElementById("GalleryMapOverride"));

            let zoomOverride = document.getElementById("GalleryMapOverride");
            if (zoomOverride != "") {
            ...
            if (document.getElementById("galleryNextJourneyCountry") != null) {
                ...
                .then((response) => {
                    ...
                    adjustedMPCenter[0] = defaultLocation.center[0]+50;
