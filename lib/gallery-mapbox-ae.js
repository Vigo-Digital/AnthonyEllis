...
function getMapDefaultLocation(location) {
    ...
    mapboxClient.geocoding.forwardGeocode({
        ...
        .then((response) => {
            ...
            var notadjustedDefaultLocation = defaultLocation;
            ...
            .then((response) => {
                ...
                const origin = notadjustedDefaultLocation.center;
                const destination = pathToLocation.center;

                var midpoint = [];
                midpoint[0] = Math.abs(notadjustedDefaultLocation.center[0])-Math.abs(pathToLocation.center[0]);
                midpoint[1] = Math.abs(notadjustedDefaultLocation.center[1])-Math.abs(pathToLocation.center[1]);
