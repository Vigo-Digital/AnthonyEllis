            ...
            if (document.getElementById("galleryNextJourneyCountry") != null) {
                ...
                .then((response) => {
                    ...
                    if (adjustedMPCenter[1] > 40) {
                        console.log("Adjusting NJ map center point down 20");
                        adjustedMPCenter[1] = adjustedMPCenter[1] - 20;
                    }
                    ...
                    if (distance > 8000) {
                        console.log("adj zoom for nj to 1.5");
                        let nextJourneyZoomLevel = 1.4
                        console.log("adj down 20");
                        adjustedMPCenter[1] = adjustedMPCenter[1] + 20;
                        adjustedZAlready = true;
                    }
                    if (distance > 6000 && adjustedZAlready != true) {
                        console.log("adj zoom for nj to 1.55");
                        let nextJourneyZoomLevel = 1.6
                        console.log("adj down 5");
