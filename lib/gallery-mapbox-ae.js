...
function getMapDefaultLocation(location) {
    ...
    mapboxClient.geocoding.forwardGeocode({
        ...
        .then((response) => {
            ...
            var notadjustedDefaultLocationCenter = defaultLocation.center;
            ...
            map.on("load", function(e) {
                ...
                console.log("defaultLocation center", notadjustedDefaultLocation);
            ...
            .then((response) => {
                ...
                const origin = notadjustedDefaultLocationCenter;
                const destination = pathToLocation.center;

                console.log("notadjustedDefaultLocation", notadjustedDefaultLocationCenter);

                var midpoint = [];
                midpoint[0] = Math.abs(notadjustedDefaultLocationCenter[0])-Math.abs(pathToLocation.center[0]);
                midpoint[1] = Math.abs(notadjustedDefaultLocationCenter[1])-Math.abs(pathToLocation.center[1]);
