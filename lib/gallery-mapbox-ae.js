    ...
    mapboxClient.geocoding.forwardGeocode({
        ...
        .then((response) => {
            ...
            .then((response) => {
                ...
                console.log("defaultLocation adj?", defaultLocation.center);
                ...
                const midpoint = turf.midpoint(origin, destination);
                const bearing = turf.bearing(origin, destination);
                const leftSideArc = bearing + 90 > 180 ? -180 + (bearing + 90 - 180) : bearing + 90;
                const mpDestination = turf.destination(midpoint, distance / 5, leftSideArc, { units: 'miles' });
