...
let defaultLocationDetails = getMapDefaultLocation(galleryCountry);
console.log("defaultLocationDetails", defaultLocationDetails);
...
function getMapDefaultLocation(location) {
    ...
    mapboxClient.geocoding.forwardGeocode({
        ...
        .then((response) => {
            ...
            console.log("defaultLocation", defaultLocation.center);
        });
    return defaultLocation.center;
}
