        ...
        .then((response) => {
            ...
            .then((response) => {
                ...
                mapnj.on("load", function(e) {
                    ...
                    mapnj.setFilter("Dynamic - Inactive Country Overlay", ["!=", "name_en", defaultLocation.place_name]);
                    mapnj.setFilter("Dynamic - Inactive Country Overlay", ["!=", "name_en", pathToLocation.place_name]);

                    mapnj.place_name.addSource('route', {
                        'type': 'geojson',
                        'data': route
                    });
                    mapnj.place_name.addLayer({
                        'id': 'route',
                        'source': 'route',
                        'type': 'line',
                        'paint': {
