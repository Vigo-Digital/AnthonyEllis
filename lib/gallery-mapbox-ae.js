        ...
        .then((response) => {
            ...
            */
            ...
            map.on("load", function(e) {
                ...
                //console.log("appplying hover layer to " . defaultLocation.place_name)
                //map.setFilter("cfh", ["==", "name_en", defaultLocation.place_name]);
            ...
            if (document.getElementById("galleryNextJourneyCountry") != null) {
                ...
                .then((response) => {
                    ...
                    if (adjustedMPCenter[1] < 20) {
                        console.log("Adjusting NJ map center point up 20");
                        adjustedMPCenter[1] = adjustedMPCenter[1] + 20;
