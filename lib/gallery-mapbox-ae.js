           ...
           /* console.log("adj", adjustedCenter);
            ...
            map.on("load", function(e) {
                ...
                map.addLayer({
                    ...
                    // "filter": ["==", "name_en", defaultLocation.place_name]
                });
                //console.log(defaultLocation.place_name);
                map.setFilter("cfh", ["==", "name", defaultLocation.place_name]);
            ...
            if (document.getElementById("galleryNextJourneyCountry") != null) {
                ...
                if (galleryNextJourneyCountry.innerHTML == "Bosnia") {
                    galleryNextJourneyCountry.innerHTML = "Bosnia and Herzegovina";
                }
                ...
                .then((response) => {
                    ...
                    console.log("original adjustedMPCenter[0]", adjustedMPCenter[0]);
                    console.log("original adjustedMPCenter[1]", adjustedMPCenter[1]);

                    let adjusted0Already = false;
                    let adjusted1Already = false;
                    let adjustedZAlready = false;

                    if (adjustedMPCenter[0] < 20) {
                        console.log("Adjusting NJ map center point right");
                        adjustedMPCenter[0] = adjustedMPCenter[0] + 60;
                    }
                    if (adjustedMPCenter[1] < 20) {
                        console.log("Adjusting NJ map center point up 8");
                        adjustedMPCenter[1] = adjustedMPCenter[1] + 8;
                        adjusted1Already = true;
                    }
                    if (adjustedMPCenter[1] < 10 && adjusted1Already != true) {
                        console.log("Adjusting NJ map center point up 10");
                        adjustedMPCenter[1] = adjustedMPCenter[1] + 10;
                    }
                    if (adjustedMPCenter[1] > 40) {
                        console.log("Adjusting NJ map center point down 10");
                        adjustedMPCenter[1] = adjustedMPCenter[1] - 10;
                    }
                    ...
                    if (distance > 8000) {
                        //console.log("adj zoom for nj to 1.4");
                        let nextJourneyZoomLevel = 1.4
                        //console.log("adj up 5");
                        adjustedMPCenter[1] = adjustedMPCenter[1] + 5;
                        adjustedZAlready = true;
                    }
                    if (distance > 6000 && adjustedZAlready != true) {
                        //console.log("adj up 5");
                        adjustedMPCenter[1] = adjustedMPCenter[1] - 5;
                    }
