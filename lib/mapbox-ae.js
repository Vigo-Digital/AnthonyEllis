...
map.on("load", function(e) {
      ...
      input.addEventListener("input", function(event) {
        ...
        var eachYearRangeX = [];
        for (var eyRRiX = rangeYearFrom; eyRRiX <= rangeYearTo; eyRRiX++) {
            eachYearRangeX.push(eyRRiX);
        }
    ...
    input2.addEventListener("input", function(event) {
        ...
        var eachYearRangeY = [];
        for (var eyRRiY = rangeYearFrom; eyRRiY <= rangeYearTo; eyRRiY++) {
            eachYearRangeY.push(eyRRiY);
        }
