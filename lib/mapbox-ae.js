    ...
    // When the user moves their mouse over the page, we look for features
            ...
            map.on("mousemove", function(e) {
              ...
              const displayFeatures = features.map((feat) => {
                ...
                if (displayFeat.properties.continent == "Europe") {
                ...
                if (displayFeat.properties.continent == "Asia") {
                  map.setLayoutProperty("Asia Fill", 'visibility', 'visible');
                } else {
                  map.setLayoutProperty("Asia Fill", 'visibility', 'none');
                }
              });
