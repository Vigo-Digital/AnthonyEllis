      ...
      input.addEventListener("input", function(event) {
       ...
       console.log("Selected Years", selectedYears);
        ...
        /*map.setFilter('marker-points', [
          ...
          if (germanyFeature) {
            const germanyYears = germanyFeature.properties.years;

            console.log("Germany years:", germanyYears);
            console.log("Type of germanyYears:", typeof germanyYears);
            console.log("Is germanyYears an array?", Array.isArray(germanyYears));
          } else {
