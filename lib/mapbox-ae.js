      ...
      input.addEventListener("input", function(event) {
       ...
       console.log("Selected Years", selectedYears);
        ...
        /*map.setFilter('marker-points', [
          ...
          const germany = map.getSource('marker-points')._data.features.find(f => f.properties.id === "germany");
console.log("Germany years:", germany.properties.years);
console.log("Type of Germany years:", typeof germany.properties.years);
console.log("Is array:", Array.isArray(germany.properties.years));
        ...
        mbfeatures.forEach(f => {
          ...
          map.setFilter('marker-points', [
            ...
            map.setFilter('marker-points', [
                ...
                const germany = map.getSource('marker-points')._data.features.find(f => f.properties.id === "germany");
                console.log("Germany2 years:", germany.properties.years);
                console.log("Type of Germany2 years:", typeof germany.properties.years);
                console.log("Is array:", Array.isArray(germany.properties.years));
