      ...
      input.addEventListener("input", function(event) {
       ...
       console.log("Selected Years", selectedYears);
        ...
        /*map.setFilter('marker-points', [
          ...
          console.log("Germany feature:", map.getSource('marker-points')._data.features.find(f => f.properties.id === 'germany'));
console.log("Germany years type:", typeof map.getSource('marker-points')._data.features.find(f => f.properties.id === 'germany').properties.years);
          const filter = ["any"];
