...
function addMapPinLocation(location, lid, lif, locationyears, locationcountry) {
    ...
    mapboxClient.geocoding.forwardGeocode({
        ...
        .then((response) => {
            ...
            console.log('locationyears raw:', locationyears);
            const locationyearsarray = locationyears.split(',').map(y => y.trim());
            console.log('locationyearsarray raw:', locationyearsarray);
            //const locationyearsarray = JSON.parse(locationyears);
      ...
      input.addEventListener("input", function(event) {
       ...
       console.log("Selected Years", selectedYears);
        ...
        /*map.setFilter('marker-points', [
          ...
          if (!source) {
            console.warn('Source "marker-points" not found');
          } else {
            const features = source._data?.features || [];
            const germany = features.find(f => f.properties.id === 'germany');
            if (germany) {
              console.log("Germany years:", germany.properties.years);
              console.log("Germany years type:", typeof germany.properties.years);
            } else {
              console.warn("Germany feature not found");
            }
          }
          const filter = ["any"];
