...
function removeGalleriesFromSlider(rangeYearFrom, rangeYearTo) {
    ...
    mapLocations.features.forEach((location) => {
        ...
        console.log("check 1", separatedgalleryYearsArray[0] + "<" + rangeYearFrom);
        console.log("check and 1", separatedgalleryYearsArray[0] + ">" + toGalleryYear);
        console.log("check 2", separatedgalleryYearsArray[actualMaxYearItem] + "<" + rangeYearTo);
        console.log("check and 2", separatedgalleryYearsArray[actualMaxYearItem] + ">" + toGalleryYear);

        console.log("separatedgalleryYearsArray.length", separatedgalleryYearsArray.length);
        console.log("--------");

        if (
            (separatedgalleryYearsArray[0] <= rangeYearFrom) || (separatedgalleryYearsArray[0] >= toGalleryYear)
            &&
            (separatedgalleryYearsArray[actualMaxYearItem] <= rangeYearTo) || (separatedgalleryYearsArray[actualMaxYearItem] >= toGalleryYear)
        ) {
            removeGalleryCount++;
...
map.on("load", function(e) {
    ...
    map.on("click", "cfh", (e) => {
        ...
        mapLocations.features.forEach((mpLoc) => {
            //console.log("Check mapLocation for", mpLoc.properties.country + "vs + " + description)
