...
function removeGalleriesFromSlider(rangeYearFrom, rangeYearTo) {
    ...
    mapLocations.features.forEach((location) => {
        ...
        console.log("check", rangeYearFrom + ">=" + separatedgalleryYearsArray[0] + "&&" + rangeYearTo + "<=" + separatedgalleryYearsArray[actualMaxYearItem]);
        console.log("--------");

        if ((rangeYearFrom >= separatedgalleryYearsArray[0]) && (rangeYearTo <= separatedgalleryYearsArray[actualMaxYearItem])) {
            removeGalleryCount++;
