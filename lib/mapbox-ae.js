...
function getGeoData() {
            ...
            if ((rangeYearFrom <= separatedArray[i]) && (rangeYearTo >= separatedArray[i])) {
                ...
                if (found == 1) {
                  if (mapPinLocationOverride != "") {
                      ...
                      let geoData = addMapPinLocation(mapPinLocationOverride, locationID, locationInfo);
                      console.log("mapLocations.features", mapLocations.features);
                      console.log("geoData", mapLocations.features);
                      if (map.getSource("points")) {
                        console.log("here1", mapLocations.features);
                        map.getSource('points').setData(mapLocations.features);
                      }
                  } else {
                      //console.log("Adding", mapPinLocation);
                      let geoData = addMapPinLocation(mapPinLocation, locationID, locationInfo);
                      console.log("geoData", mapLocations.features);

                      if (map.getSource("points")) {
                        console.log("here2", mapLocations.features);
                        map.getSource('points').setData(mapLocations.features);
                      }
                  }
                }
    ...
    //console.log("map locations 2", mapLocations);
}
